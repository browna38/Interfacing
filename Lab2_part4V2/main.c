...
#define LED                    (*((volatile uint32_t *)0x4006403C))
...
//	unsigned long Green_output;
//	unsigned long Yellow_output;
//	unsigned long Red_output;
//	unsigned long Green;
...
typedef struct STATES myState; 
enum state_codes { 
Green_output = 0, Yellow = 1,Yellow_output = 1, Red = 2, Red_output = 2, Green = 0};

myState Fsm[3] = {{Green_output,5, Yellow},
	{Yellow_output,4, Red},
	{Red_output,5, Green}
};
